...
<div class="container d-flex" style="font-family: 'Fira Sans', sans-serif; margin-bottom: 100px; margin-top: 100px; ">
  <div class="col-md-11">
    <div class="card rounded-4 shadow mb-5 mt-5 h-100" >
      <div class="card-body">
        ...
        <table class="table table-light table-hover" height="100">
          ...
          <tbody class="table-group-divider h-100">
            ...
            <tr class="mb-4">
              ...
              onchange="updateAmount(this, '<?php echo $product->id; ?>', '<?php echo $_SESSION['user_id']; ?>')" /></td>
  ...
  <div class="col-md-3 d-none d-md-block mt-5" style="font-family: 'Fira Sans', sans-serif; margin-bottom: 100px; margin-top: 100px; ">
    <div class="p-1">
