                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a 
                                                ...
                                                class="btn btn-warning text-white text-center btn-rounded"
                                            >Update</a>
                                        </td>
                                        <td>
                                            <!-- Button to Open the Modal -->
                                            <button type="button" class="btn btn-danger text-center btn-rounded" data-bs-toggle="modal" data-bs-target="#deleteCategoryModal<?php echo $category->id; ?>">
                                                Delete
                                            </button>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-danger " onclick="location.href='<?php echo ADMINURL; ?>/categories-admins/delete-category.php?id=<?php echo $category->id; ?>'">Yes</button>
