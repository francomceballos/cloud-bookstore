 ...
 ?>
        ...
        <?php foreach($allRows as $product): ?>
            <div class="col-lg-4 col-md-6 col-sm-10 offset-md-0 offset-sm-1">
                <div class="card mb-5">
                    <img height="213px" src="<?php echo APPURL; ?>/images/<?php echo $product->image; ?>" class="card-img-top">
                    <div class="card-body">
                        <h5 class="d-inline"><b><?php echo $product->name; ?></b></h5>
                        <h5 class="d-inline text-muted"><div>(<?php echo $product->price; ?>/item)</div></h5>
